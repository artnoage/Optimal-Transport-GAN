...
class Assignment_model:
    ...
    def define_graph(self):
        ...
        self.generate_latent_batch_noisy=self.latent.tensor()+0.2*tf.random_normal(shape=(self.latent.batch_size, self.latent.shape))
    ...
    def train_generator(self, session, real_idx, latent_sample, offset=2000):
        ...
        for c_idx in range(0, int(len(real_idx) - offset + 1), int(offset)):
            ...
            cost.append(A)
        print("The trasportation distance is", np.sqrt(np.average(A)))