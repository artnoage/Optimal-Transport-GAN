...
from logger.Plotting import generate_density, plot_fake_and_real, make_image_grid, wasserstein_distance
...
class LoggerFacade:
    ...
    def log_image_grid_fixed(self, first_rows, second_rows, n_iterations, name="real_and_fake_images",save_image=False,):
        """
